...
for content_path in content_paths:
    for style_path in style_paths:
        ...
        #因为mac有/.DS_Store文件，会影响PIL的Image.open读取
        #这段代码起一个文件过滤的作用
        content_tf1 = content_transform()
        pth1, fle1 = os.path.split(content_path)
        if fle1.endswith('jpg') | fle1.endswith('png') | fle1.endswith('jpeg') | fle1.endswith('JPG') | fle1.endswith('PNG'):
        ...
        pth2, fle2 = os.path.split(style_path)
        if fle2.endswith('jpg') | fle2.endswith('png') | fle1.endswith('jpeg') | fle2.endswith('JPG') | fle2.endswith('PNG'):
